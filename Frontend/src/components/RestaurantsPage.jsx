  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-8 lg:px-16">
      ...
      >
        ...
        <button
          type="submit"
          className="px-6 py-2 bg-blue-500 text-white rounded-r-md hover:bg-blue-600 transition duration-300"
        >
          Search
        </button>
      </form>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {filteredRestaurants.length > 0 ? (
          ...
          <p className="text-center text-gray-600 col-span-full">No restaurants found for this location.</p>
        )}
      </div>
    </div>
  );
